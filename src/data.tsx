...
export const fermentableAdditions: Fermentable[] = [
  ...
  { type: 'grain', name: 'Caramünch 2', producer: 'Weyermann' },
  { type: 'grain', name: 'Caramünch 3', producer: 'Weyermann' },
  { type: 'grain', name: 'Carapils', producer: 'Weyermann' },
  { type: 'grain', name: 'Carared', producer: 'Weyermann' },
  { type: 'grain', name: 'Cararye', producer: 'Weyermann' },
  ...
  { type: 'grain', name: 'Flaked Torrefied Oats', producer: 'Crisp' },
  ...
  { type: 'grain', name: 'Naked Oat Malt', producer: 'Crisp' },
  ...
  { type: 'sugar', name: 'Demerara sugar', producer: 'Dansukker' },
...
export const hopAdditions: Hop[] = [
  ...
  { name: 'Nectaron', form: 'pellet', alpha_acid: { unit: '%', value: 9.4 }, origin: 'New Zealand', year: '2022' },
  ...
  { name: 'Simcoe', form: 'pellet', alpha_acid: { unit: '%', value: 13.4 }, origin: 'USA', year: '2020' },
...
export const cultureAdditions: BeerJSON.CultureBase[] = [
  ...
  { type: 'ale', form: 'dry', name: 'New England', producer: 'Lallemand' },
  ...
  { type: 'ale', form: 'dry', name: 'Windsor Ale', producer: 'Lallemand' },
  { type: 'ale', form: 'liquid', name: 'London Fog WLP066', producer: 'White Labs' },
